...
void ui_MainScreen_screen_init(void)
{
    ...
    ui_Venus_Wallpaper = lv_img_create(ui_MainScreen);
    lv_img_set_src(ui_Venus_Wallpaper, &ui_img_test_venus_320x240_png);
    lv_obj_set_width(ui_Venus_Wallpaper, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Venus_Wallpaper, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_Venus_Wallpaper, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_Venus_Wallpaper, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_Venus_Wallpaper, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_opa(ui_Venus_Wallpaper, 5000, LV_PART_MAIN | LV_STATE_DEFAULT);
